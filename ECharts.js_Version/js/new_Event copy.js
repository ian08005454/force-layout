    ...
    function data_filter() {
        ...
        function data_filter_max_level_2() {
            option.series[0].categories = data.category.filter(category => {
                ...
                if (test.includes(category.target) && test.includes(category.source)) {
                    console.log(test);
                    return category;
                }

                // return keyword.includes(category.target) || keyword.includes(category.source);
                // return (test.includes(category.target) && test.includes(category.source)) || (keyword.includes(category.target) || keyword.includes(category.source))
            });
